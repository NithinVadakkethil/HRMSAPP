...
//         <TouchableOpacity className="border border-gray-300 rounded-md py-2 px-3 flex-row items-center">
//           {/* View icon would go here */}
//           <Eye />
//           <Text className="text-gray-700 ml-1">View</Text>
//         </TouchableOpacity>
//         <TouchableOpacity className="bg-[#023247] rounded-md py-2 px-4 flex-row items-center">
...
const DocumentRow = ({ 
  ...
  return (
    <View className={`mb-6 p-3 rounded-lg ${isSelected ? 'bg-blue-50 border border-blue-300' : 'bg-white'}`}>
      <Text className="text-lg font-bold text-gray-800 mb-2">{sectionTitle}</Text>
      {idNumber && (
