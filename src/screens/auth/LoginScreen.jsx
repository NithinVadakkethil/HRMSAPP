...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.log('Login response:', response); // Keep this for debugging
      
      if (response.results.token) {
        // Get user data from response.results.data (the correct path)
        const userData = response.results.data;
        console.log('User data to store:', userData); // Keep this for debugging
